...
class HmsScanViewManager :
  ...
  public override fun createViewInstance(context: ThemedReactContext): HmsScanView =
    HmsScanView(context)

  @ReactProp(name = "formatsCsv")
  override fun setFormatsCsv(view: HmsScanView?, value: String?) {
    view?.setFormatsCsv(value)
  }

  @ReactProp(name = "continuous", defaultBoolean = true)
  override fun setContinuous(view: HmsScanView?, value: Boolean) {
    view?.setContinuous(value)
  }

  @ReactProp(name = "paused", defaultBoolean = false)
  override fun setPaused(view: HmsScanView?, value: Boolean) {
    view?.setPaused(value)
  }

  @ReactProp(name = "torch", defaultBoolean = false)
  override fun setTorch(view: HmsScanView?, value: Boolean) {
    view?.setTorch(value)
  }
