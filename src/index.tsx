...
// 0.2.1：package.json#files 补 scripts/，修 pod install 缺 prepare-scankit-xcframework.sh（podspec prepare_command 调用）。
// 文档站：https://unif-design.github.io/react-native-hms-scan/（版本随发版自动部署）。
