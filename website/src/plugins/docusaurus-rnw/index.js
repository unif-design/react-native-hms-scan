 ...
 *
 * Native module(NativeHmsScan)在浏览器里没有原生侧,
 * 仅用于文档页面的 markdown 文档渲染,真实扫码调用要在 RN runtime。
 */
'use strict';
      ...
      return {
        ...
        resolve: {
          alias: {
            ...
            // 业务侧若用到 codegen 类原生组件,在该 RN 组件的 wrapper 旁边加
        ...
        module: {
          rules: [
            ...
            // node_modules 里 ESM-shipped RN 库(@sbaiahmed1/react-native-blur、
